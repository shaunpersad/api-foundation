...
class GPlusAccessToken implements GrantTypeInterface {
    ...
    public function validateRequest(RequestInterface $request, ResponseInterface $response)
    {
        ...
        $gplus_access_token = $request->request($identifier);
        ...
        try {
            ...
            $response->setError(400, 'invalid_request', "Google Plus access token is invalid. Possibly expired.");
            return null;
        }
